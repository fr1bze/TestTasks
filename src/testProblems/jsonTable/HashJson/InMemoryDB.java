package testProblems.jsonTable.HashJson;
...
public class InMemoryDB {
    ...
    public static void main(String[] args) {
        ...
        Record record2 = new Record(2112521L, "Петров Андрей Алексеевич", 2012.25);
        db.addRecord(record1);
        db.addRecord(record2);
        System.out.println(db.getRecord("name","Иванов Иван Иванович"));
        System.out.println(db.getRecord("value","2012.25"));
